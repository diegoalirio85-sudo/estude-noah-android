...
## Princípio
Avaliar compreensão do objetivo de aprendizagem, não memória de frases.

## Análise obrigatória
Produzir internamente: matéria, assunto, temas, objetivo didático, conceitos, relações, processos, causas/consequências, comparações, vocabulário e equívocos plausíveis.

## Verdadeiro/Falso
Variar entre compreensão conceitual, relação, causa/consequência, comparação, classificação, função, sequência, aplicação e inferência.

Evitar:
- mera troca de data/número;
- acrescentar “não”;
- copiar frase do material.

## Explicação
Feedback curto, corretivo e sustentado pelo material.
